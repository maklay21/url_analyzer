...
type AnalyzeResponse struct {
	...
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`                     // pending, processing, completed, failed, insufficient_data
	Summary       string                 `protobuf:"bytes,3,opt,name=summary,proto3" json:"summary,omitempty"`                   // результат анализа
	FilePath      string                 `protobuf:"bytes,4,opt,name=file_path,json=filePath,proto3" json:"file_path,omitempty"` // путь к сохранённому файлу
...
func (x *TaskItem) Reset() {
	*x = TaskItem{}
	mi := &file_proto_analyzer_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TaskItem) Descriptor() ([]byte, []int) {
	return file_proto_analyzer_proto_rawDescGZIP(), []int{4}
}
...
func (x *ListTasksResponse) Reset() {
	*x = ListTasksResponse{}
	mi := &file_proto_analyzer_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListTasksResponse) Descriptor() ([]byte, []int) {
	return file_proto_analyzer_proto_rawDescGZIP(), []int{5}
}
...
const file_proto_analyzer_proto_rawDesc = "" +
	...
	"\aAnalyze\x12\x18.analyzer.AnalyzeRequest\x1a\x19.analyzer.AnalyzeResponse\x12>\n" +
	"\aGetTask\x12\x18.analyzer.GetTaskRequest\x1a\x19.analyzer.AnalyzeResponse\x12D\n" +
	"\tListTasks\x12\x1a.analyzer.ListTasksRequest\x1a\x1b.analyzer.ListTasksResponseB\x1aZ\x18backend/internal/grpcapib\x06proto3"
...
var file_proto_analyzer_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
